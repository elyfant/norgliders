...
| 3/4/5 | ogdp | `~/projects/ogdp` | [elyfant/ogdp](https://github.com/elyfant/ogdp) | Ocean Glider Data Pipeline — raw data ingestion (SFMC/rsync), near-real-time + delayed-mode processing (PyGlider + IOOS QC), aiming for a platform-agnostic OG1 output |
...
## 3. Raw Data Ingestion — `~/projects/ogdp` · [elyfant/ogdp](https://github.com/elyfant/ogdp)
...
## 4. NRT Processing — `~/projects/ogdp` · [elyfant/ogdp](https://github.com/elyfant/ogdp)
...
## 5. Delayed-Mode Processing — `~/projects/ogdp` · [elyfant/ogdp](https://github.com/elyfant/ogdp)
